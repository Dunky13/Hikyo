...
editUrl: https://github.com/Dunky13/hikyo/edit/main/docs/site/src/content/docs/docs/troubleshooting.mdx
---
...
Report vulnerabilities through the [private security channels](/hikyo/security/).
