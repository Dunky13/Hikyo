...
editUrl: https://github.com/Dunky13/hikyo/edit/main/docs/site/src/content/docs/docs/cli-reference.mdx
---
...
`--context`. Resolution is documented in [contexts and targets](/hikyo/docs/contexts/).
