...
> **Amended by the flat-model ADR ([flat-model.md](./flat-model.md), 2026-08-06, [#40](https://github.com/Dunky13/envweave/issues/40)):** the inheritance-model interim state recorded below is discharged — #40 is locked; C1 and C2 carry their final criterion text (per that ADR's Propagations).
