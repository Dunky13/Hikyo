# Wenv MVP boundary & acceptance criteria (ADR, locked 2026-08-06)
...
| A5 | Reveal ceremonies: purpose-bound reauth (passkey/TOTP), sliding window, protected caps at 0, clipboard = audited disclosure, one event per key | [permission-model.md](./permission-model.md), [#21](https://github.com/Dunky13/wenv/issues/21) | [UI] ceremony for reveal, publish-into-protected, copy; window countdown + remask; per-key audit rows asserted [E2E] effective window 0 forces WebAuthn per disclosure (TOTP refused) |
...
| O5 | Governance & licensing artifacts: GOVERNANCE.md (BDFL + continuity + amendment procedure), TRADEMARK.md, no-`/ee` pledge in README, MPL-2.0 LICENSE, DCO | [oss-mechanics.md](./oss-mechanics.md), [license (#9)](https://github.com/Dunky13/wenv/issues/9) | [CI] file-presence + pinned-content assertions on the locked clauses (pledge text, amendment procedure section, MPL-2.0 exact text) |
...
### 2.1 GitHub Actions deployment adapter ([#36](https://github.com/Dunky13/wenv/issues/36))
...
### 2.2 SAML (SP) ([#37](https://github.com/Dunky13/wenv/issues/37))
...
### 2.4 Secret scanning ([#39](https://github.com/Dunky13/wenv/issues/39))
...
| HA / scale-out | [ops-spec](./ops-spec.md), [#3](https://github.com/Dunky13/wenv/issues/3) | Out. Trigger: post-1.0 demand; single-region HA first |
...
2. **Domain core** — keys/schema ([schema-model](./schema-model.md)), flat value model ([#40](https://github.com/Dunky13/wenv/issues/40)), revisions/publish ([revision-model](./revision-model.md)).
...
6. **Machine identities + federation** ([machine-identities](./machine-identities.md)), then delivery: Compose ([compose-integration](./compose-integration.md)) → K8s operator ([k8s-integration](./k8s-integration.md)) → adapters: Forgejo ([deployment-adapter](./deployment-adapter.md)) + GitHub ([#36](https://github.com/Dunky13/wenv/issues/36)).
7. **Import family** ([import-paths](./import-paths.md)), **multi-instance** ([multi-instance](./multi-instance.md)), machine-access UI.
8. **Promotions build** — SAML + SCIM (extend the phase-3 auth core; their locked designs have been waiting since synthesis), secret scanning ([#39](https://github.com/Dunky13/wenv/issues/39)).
...
- Synthesis (#27) is blocked by five tickets: [#36](https://github.com/Dunky13/wenv/issues/36) GitHub adapter, [#37](https://github.com/Dunky13/wenv/issues/37) SAML, [#38](https://github.com/Dunky13/wenv/issues/38) SCIM, [#39](https://github.com/Dunky13/wenv/issues/39) secret scanning, [#40](https://github.com/Dunky13/wenv/issues/40) flat-model amendment.
