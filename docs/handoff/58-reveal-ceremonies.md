...
Parent #41. Binds [permission-model.md](https://github.com/Hikyo-Org/Hikyo/blob/main/docs/adr/permission-model.md)
§ *The reveal guard* and § *Disclosure by proxy*, [audit-model.md](https://github.com/Hikyo-Org/Hikyo/blob/main/docs/adr/audit-model.md)
(one disclosure event per key), [human-auth.md](https://github.com/Hikyo-Org/Hikyo/blob/main/docs/adr/human-auth.md)
