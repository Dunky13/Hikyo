...
results=$2
plan=$3
expected_results='["changes","client","dco","docs","fuzz","generated","headline-guarantee","k8s-e2e","lint","race","release-snapshot","supply-chain-checks","test","web"]'
expected_plan='["client","docs","fuzz","generated","headline_guarantee","k8s_e2e","lint","race","release_snapshot","supply_chain_checks","test","web"]'
