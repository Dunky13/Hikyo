...
--     never occurred.
ALTER TABLE auth_instance_state ADD COLUMN restore_epoch INTEGER NOT NULL DEFAULT 0;
ALTER TABLE auth_instance_state ADD COLUMN reactivated_at TEXT;
...
ALTER TABLE principals ADD COLUMN reconciled_epoch INTEGER NOT NULL DEFAULT 0;
