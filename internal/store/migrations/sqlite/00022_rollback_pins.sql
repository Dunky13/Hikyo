...
ALTER TABLE pending_changes ADD COLUMN secret INTEGER NOT NULL DEFAULT 0
    CHECK (secret IN (0, 1));
ALTER TABLE pending_changes ADD COLUMN material_secret INTEGER NOT NULL DEFAULT 0
    CHECK (material_secret IN (0, 1));
