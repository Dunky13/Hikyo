...
CREATE TABLE cli_reauth_handoffs (
    ...
    approved_windows JSONB NOT NULL DEFAULT '[]'::jsonb,
...
CREATE TABLE adapter_targets (
    ...
    failure_names JSONB NOT NULL DEFAULT '[]'::jsonb,
    converged_revision BIGINT,
    active_job_id TEXT,
...
CREATE TABLE adapter_route_move_targets (
    ...
    destination_id BIGINT NOT NULL CHECK (destination_id >= 0),
    name_prefix TEXT NOT NULL,
    orphaned_names JSONB NOT NULL DEFAULT '[]'::jsonb,
...
ALTER TABLE adapter_conflicts ADD CONSTRAINT adapter_conflicts_job_chain_fk
    FOREIGN KEY (org_id, project_id, environment_id, job_id)
    REFERENCES adapter_outbox (org_id, project_id, environment_id, id);
