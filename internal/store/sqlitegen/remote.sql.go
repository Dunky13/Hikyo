...
func (q *Queries) ApproveWorkspaceHandoff(ctx context.Context, arg ApproveWorkspaceHandoffParams) (int64, error) {
	result, err := q.db.ExecContext(ctx, approveWorkspaceHandoff,
		arg.CodeVerifier,
		arg.PrincipalID,
		arg.Factors,
		arg.FactorClass,
...
func (q *Queries) ConsumeWorkspaceHandoff(ctx context.Context, arg ConsumeWorkspaceHandoffParams) (int64, error) {
	result, err := q.db.ExecContext(ctx, consumeWorkspaceHandoff, arg.ConsumedAt, arg.ID)
	if err != nil {
		return 0, err
	}
	return result.RowsAffected()
...
func (q *Queries) CountRemotes(ctx context.Context) (int64, error) {
	row := q.db.QueryRowContext(ctx, countRemotes)
	var count int64
	err := row.Scan(&count)
	return count, err
}
...
func (q *Queries) CreateInstanceConnection(ctx context.Context, arg CreateInstanceConnectionParams) error {
	_, err := q.db.ExecContext(ctx, createInstanceConnection,
		arg.ID,
		arg.PrincipalID,
		arg.Label,
		arg.Kind,
...
func (q *Queries) CreateRemote(ctx context.Context, arg CreateRemoteParams) error {
	_, err := q.db.ExecContext(ctx, createRemote,
		arg.ID,
		arg.Name,
		arg.Url,
		arg.SpkiPin,
...
// hikyo:authn-resolution
func (q *Queries) DeleteExpiredWorkspaceHandoffs(ctx context.Context, expiresAt string) (int64, error) {
	result, err := q.db.ExecContext(ctx, deleteExpiredWorkspaceHandoffs, expiresAt)
	if err != nil {
		return 0, err
	}
	return result.RowsAffected()
...
func (q *Queries) DeleteRemote(ctx context.Context, id string) (int64, error) {
	result, err := q.db.ExecContext(ctx, deleteRemote, id)
	if err != nil {
		return 0, err
	}
	return result.RowsAffected()
...
func (q *Queries) DeleteWorkspaceOrigin(ctx context.Context, origin string) (int64, error) {
	result, err := q.db.ExecContext(ctx, deleteWorkspaceOrigin, origin)
	if err != nil {
		return 0, err
	}
	return result.RowsAffected()
...
func (q *Queries) GetInstanceConnection(ctx context.Context, id string) (GetInstanceConnectionRow, error) {
	row := q.db.QueryRowContext(ctx, getInstanceConnection, id)
...
func (q *Queries) GetRemoteByName(ctx context.Context, name string) (GetRemoteByNameRow, error) {
	row := q.db.QueryRowContext(ctx, getRemoteByName, name)
...
func (q *Queries) GetRemoteSnapshot(ctx context.Context, remoteID string) (RemoteSnapshot, error) {
	row := q.db.QueryRowContext(ctx, getRemoteSnapshot, remoteID)
...
func (q *Queries) GetWorkspaceOrigin(ctx context.Context, origin string) (WorkspaceOrigin, error) {
	row := q.db.QueryRowContext(ctx, getWorkspaceOrigin, origin)
...
func (q *Queries) InsertWorkspaceHandoff(ctx context.Context, arg InsertWorkspaceHandoffParams) error {
	_, err := q.db.ExecContext(ctx, insertWorkspaceHandoff,
		arg.ID,
		arg.StateVerifier,
		arg.Origin,
		arg.RedirectUri,
...
func (q *Queries) InsertWorkspaceOrigin(ctx context.Context, arg InsertWorkspaceOriginParams) error {
	_, err := q.db.ExecContext(ctx, insertWorkspaceOrigin, arg.Origin, arg.CreatedAt, arg.CreatedBy)
	return err
}
...
func (q *Queries) InstanceConnectionByVerifier(ctx context.Context, verifier []byte) (InstanceConnection, error) {
	row := q.db.QueryRowContext(ctx, instanceConnectionByVerifier, verifier)
...
func (q *Queries) InstanceIdentity(ctx context.Context) (string, error) {
	row := q.db.QueryRowContext(ctx, instanceIdentity)
	var identity string
...
func (q *Queries) ListInstanceConnections(ctx context.Context) ([]ListInstanceConnectionsRow, error) {
	rows, err := q.db.QueryContext(ctx, listInstanceConnections)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) ListRemoteSnapshots(ctx context.Context) ([]RemoteSnapshot, error) {
	rows, err := q.db.QueryContext(ctx, listRemoteSnapshots)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) ListRemotes(ctx context.Context) ([]ListRemotesRow, error) {
	rows, err := q.db.QueryContext(ctx, listRemotes)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) ListWorkspaceOrigins(ctx context.Context) ([]WorkspaceOrigin, error) {
	rows, err := q.db.QueryContext(ctx, listWorkspaceOrigins)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
// hikyo:instance-scoped
func (q *Queries) LockInstanceIdentityRow(ctx context.Context) (int64, error) {
	row := q.db.QueryRowContext(ctx, lockInstanceIdentityRow)
	var id int64
	err := row.Scan(&id)
	return id, err
}
...
func (q *Queries) LockWorkspaceOrigin(ctx context.Context, origin string) (string, error) {
	row := q.db.QueryRowContext(ctx, lockWorkspaceOrigin, origin)
	var origin_2 string
...
func (q *Queries) RenameRemote(ctx context.Context, arg RenameRemoteParams) (int64, error) {
	result, err := q.db.ExecContext(ctx, renameRemote, arg.Name, arg.ID)
	if err != nil {
		return 0, err
	}
	return result.RowsAffected()
...
func (q *Queries) RevokeInstanceConnection(ctx context.Context, arg RevokeInstanceConnectionParams) (int64, error) {
	result, err := q.db.ExecContext(ctx, revokeInstanceConnection, arg.RevokedAt, arg.ID)
	if err != nil {
		return 0, err
	}
	return result.RowsAffected()
...
func (q *Queries) SealedRemoteCredential(ctx context.Context, id string) ([]byte, error) {
	row := q.db.QueryRowContext(ctx, sealedRemoteCredential, id)
...
func (q *Queries) TouchInstanceConnection(ctx context.Context, arg TouchInstanceConnectionParams) error {
	_, err := q.db.ExecContext(ctx, touchInstanceConnection, arg.LastUsedAt, arg.ID)
	return err
}
...
func (q *Queries) WorkspaceHandoffByCode(ctx context.Context, codeVerifier []byte) (WorkspaceHandoff, error) {
	row := q.db.QueryRowContext(ctx, workspaceHandoffByCode, codeVerifier)
...
func (q *Queries) WorkspaceHandoffByState(ctx context.Context, stateVerifier []byte) (WorkspaceHandoff, error) {
	row := q.db.QueryRowContext(ctx, workspaceHandoffByState, stateVerifier)
	var i WorkspaceHandoff
	err := row.Scan(
		&i.ID,
		&i.StateVerifier,
...
func (q *Queries) WriteRemoteSnapshot(ctx context.Context, arg WriteRemoteSnapshotParams) error {
	_, err := q.db.ExecContext(ctx, writeRemoteSnapshot,
		arg.RemoteID,
		arg.LastAttemptAt,
		arg.LastOutcome,
		arg.ObservedAt,
