...
WHERE org_id = $1 AND project_id = $2 AND environment_id = $3 AND key_id = $4 AND owner_id = $5
`
...
func (q *Queries) CountPendingChangeForCell(ctx context.Context, arg CountPendingChangeForCellParams) (int64, error) {
	row := q.db.QueryRow(ctx, countPendingChangeForCell,
		arg.OrgID,
		arg.ProjectID,
		arg.EnvironmentID,
		arg.KeyID,
...
func (q *Queries) CountPendingChangesForProject(ctx context.Context, arg CountPendingChangesForProjectParams) (int64, error) {
	row := q.db.QueryRow(ctx, countPendingChangesForProject, arg.OrgID, arg.ProjectID)
	var count int64
	err := row.Scan(&count)
	return count, err
}
...
func (q *Queries) ListPendingForReencrypt(ctx context.Context, arg ListPendingForReencryptParams) ([]ListPendingForReencryptRow, error) {
	rows, err := q.db.Query(ctx, listPendingForReencrypt,
		arg.ChainOrgID,
		arg.ChainProjectID,
		arg.Cursor,
		arg.PageLimit,
...
func (q *Queries) ListSnapshotEntriesForReencrypt(ctx context.Context, arg ListSnapshotEntriesForReencryptParams) ([]ListSnapshotEntriesForReencryptRow, error) {
	rows, err := q.db.Query(ctx, listSnapshotEntriesForReencrypt,
		arg.ChainOrgID,
		arg.ChainProjectID,
		arg.Cursor,
		arg.PageLimit,
...
UPDATE pending_changes SET ciphertext = $1
...
func (q *Queries) ReencryptPendingChange(ctx context.Context, arg ReencryptPendingChangeParams) (int64, error) {
	result, err := q.db.Exec(ctx, reencryptPendingChange,
		arg.NewCiphertext,
		arg.ChainOrgID,
		arg.ChainProjectID,
		arg.ID,
...
UPDATE snapshot_entries SET ciphertext = $1
WHERE org_id = $2 AND project_id = $3
  AND id = $4 AND ciphertext = $5
`
...
func (q *Queries) ReencryptSnapshotEntry(ctx context.Context, arg ReencryptSnapshotEntryParams) (int64, error) {
	result, err := q.db.Exec(ctx, reencryptSnapshotEntry,
		arg.NewCiphertext,
		arg.ChainOrgID,
		arg.ChainProjectID,
		arg.ID,
